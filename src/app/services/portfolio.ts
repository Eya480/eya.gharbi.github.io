...
export class Portfolio {
  private skills: Skill[] = [
    ...
    // ✅ Ajoutés — utilisés dans SolidMaint
    { id: 21, name: 'Next.js', level: 80, category: 'frontend', icon: 'fas fa-n', yearsOfExperience: 1 },
    { id: 22, name: 'Tailwind CSS', level: 80, category: 'frontend', icon: 'fas fa-palette', yearsOfExperience: 1 },
    { id: 23, name: 'shadcn/ui', level: 75, category: 'frontend', icon: 'fas fa-layer-group', yearsOfExperience: 1 },
    // ✅ Ajouté — utilisé dans Gestion Projets Web
    { id: 24, name: 'Chart.js', level: 70, category: 'frontend', icon: 'fas fa-chart-bar', yearsOfExperience: 1 },
    ...
    // ✅ Ajoutés — utilisés dans SolidMaint
    { id: 25, name: 'NestJS', level: 80, category: 'backend', icon: 'fas fa-server', yearsOfExperience: 1 },
    { id: 26, name: 'Prisma', level: 75, category: 'backend', icon: 'fas fa-database', yearsOfExperience: 1 },
    { id: 27, name: 'REST API', level: 90, category: 'backend', icon: 'fas fa-plug', yearsOfExperience: 3 },
    { id: 28, name: 'WebSocket', level: 70, category: 'backend', icon: 'fas fa-bolt', yearsOfExperience: 1 },
    { id: 29, name: 'JWT', level: 85, category: 'backend', icon: 'fas fa-key', yearsOfExperience: 2 },
    ...
    // ✅ Ajoutés — utilisés dans SolidMaint
    { id: 30, name: 'PostgreSQL', level: 80, category: 'database', icon: 'fas fa-database', yearsOfExperience: 1 },
    { id: 31, name: 'Redis', level: 70, category: 'database', icon: 'fas fa-memory', yearsOfExperience: 1 },
    ...
    // ✅ Ajouté — utilisé dans Ordonna
    { id: 32, name: 'Expo', level: 50, category: 'mobile', icon: 'fas fa-mobile-alt', yearsOfExperience: 1 },

    // Tools
    { id: 18, name: 'Git', level: 90, category: 'tools', icon: 'fab fa-git-alt', yearsOfExperience: 4 },
    { id: 20, name: 'Postman', level: 95, category: 'tools', icon: 'fas fa-paper-plane', yearsOfExperience: 2 },
    // ✅ Ajoutés — utilisés dans SolidMaint et autres projets
    { id: 33, name: 'Docker', level: 75, category: 'tools', icon: 'fab fa-docker', yearsOfExperience: 1 },
    { id: 34, name: 'Swagger', level: 85, category: 'tools', icon: 'fas fa-file-code', yearsOfExperience: 2 },
    { id: 35, name: 'Vitest', level: 75, category: 'tools', icon: 'fas fa-vial', yearsOfExperience: 1 },
    { id: 36, name: 'Playwright', level: 70, category: 'tools', icon: 'fas fa-theater-masks', yearsOfExperience: 1 },
    { id: 37, name: 'Grafana k6', level: 65, category: 'tools', icon: 'fas fa-tachometer-alt', yearsOfExperience: 1 },
    { id: 38, name: 'OWASP ZAP', level: 65, category: 'tools', icon: 'fas fa-shield-alt', yearsOfExperience: 1 },
    { id: 39, name: 'Figma', level: 70, category: 'tools', icon: 'fab fa-figma', yearsOfExperience: 2 },
    { id: 40, name: 'Scrum / Agile', level: 85, category: 'tools', icon: 'fas fa-tasks', yearsOfExperience: 2 },

    // ✅ Nouvelle catégorie IA — SolidMaint
    { id: 41, name: 'LLaMA 3.3 70B', level: 70, category: 'ai', icon: 'fas fa-brain', yearsOfExperience: 1 },
    { id: 42, name: 'Groq Cloud', level: 70, category: 'ai', icon: 'fas fa-microchip', yearsOfExperience: 1 },
    { id: 43, name: 'Prompt Engineering', level: 75, category: 'ai', icon: 'fas fa-comment-dots', yearsOfExperience: 1 },
  ];
  private projects: Project[] = [
    ...
    ,
    {
      ...
      imageUrl: 'assets/mobileGestionO.png',
      technologies: [
        'React Native 0.81',
        'Expo SDK 54',
        'React Navigation v7',
    ...
    ,
    {
      ...
      imageUrl: 'assets/gestion-vols.jpg',
      technologies: [
        'Java',
        'JavaFX',
        'MySQL',
    ...
    {
      id: 12,
      title: 'SolidMaint — Gestion de Maintenance B2B',
      description: 'Application web B2B de gestion des contrats de maintenance avec assistance IA intégrée, développée en stage PFE chez SolidWall Consulting.',
      detailedDescription: `Plateforme B2B complète développée en binôme lors du projet de fin d'études chez SolidWall Consulting. 
  Fonctionnalités : gestion contractuelle, suivi des tickets en Kanban, 
  messagerie temps réel via WebSocket, module d'assistance IA basé sur LLaMA 3.3 70B (Groq Cloud) 
  pour la classification automatique des demandes avec score de confiance, analyse des blocages 
  et génération d'articles de base de connaissances. 
  Pipeline IA robuste : anonymisation PII, cache MD5, retry avec backoff exponentiel, rate limiting et traçabilité complète. 
  Authentification RBAC, OAuth Google/GitHub, journal d'activités, tableaux de bord analytiques 
  et génération de rapports PDF. 
  Tests : unitaires Vitest, E2E Playwright, performance Grafana k6, sécurité OWASP ZAP.`,
      imageUrl: 'assets/solidmaint.png',
      technologies: [
        'Next.js',
        'NestJS',
        'TypeScript',
